...
<%
	...
	String msg_input = "비회원이시면 회원 가입을 해주세요.";
	String msg_id_x   =  " 이 아이디는 사용할 수 없습니다.";
	String msg_id_o	  = "는 사용할수 있습니다.";
	String msg_login = "로그인을 해주세요";
	String msg_main   = "님 안녕하세요.";
	String msg_passwd = "비밀번호를 다시 확인해주세요";
	String msg_modify = "수정할 정보를 입력 하세요.";
